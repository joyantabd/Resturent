                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1">
                            <div class="section-header">
                                <h2 class="pricing-title">Our Product Menu Pricing</h2>
                                <ul id="filter-list" class="clearfix">
                                    <li class="filter" data-filter="all">All</li>
                                    @foreach($categories as $category)
                                        <li class="filter" data-filter="#{{ $category->slug }}">{{ $category->name }} <span class="badge">{{ $category->items}}</span></li>
                                    @endforeach
                                </ul><!-- @end #filter-list -->
                            </div>
                        </div>
                    ...
                    <ul id="menu-pricing" class="menu-price">
                        ...
                        @foreach($items as $item)
                            <li class="item" id="{{ $item->category->slug }}">
                                ...
                                <h2 class="white">{{$item->price}} BDT</h2>
                            </li>
                            @endforeach
                        ...
                        <form class="reservation-form" method="post" action="{{route('reservation.reserve')}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control reserve-form empty iconified" name="datetime" id="datetimepicker1" placeholder="&#xf017;  Time">
                                    </div>
                                </div>
    ...
    <div class="container-fluid color-bg">
        <div class="row dis-table">
            ...
            <div class="col-xs-6 col-sm-6 dis-table-cell">
                <div class="section-content">
                    <p>12/B , Sector #10 , Uttara Model Town ,Dhaka-1230</p>
                    <p>+88 01673975520</p>
                    <p>agamirbarta21@gmail.com </p>
                </div>
            </div>
        </div>
